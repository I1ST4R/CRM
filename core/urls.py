...
urlpatterns = [
    ...
    path('order/report/', views.order_report, name='order_report_user'),
    path('order/report/export/', views.export_order_report, name='export_order_report_user'),
    ...
    path('orders/item/<int:item_id>/delete/', views.order_item_delete, name='order_item_delete'),
